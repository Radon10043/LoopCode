...
#sleep 5s
#$AFL/afl-fuzz -p -y -k 180 -l $line -t 1000+ -e 1 -m none -i /home/lowry/Documents/LoopCode/scripts/jasper_in3 -o $SUBJECT/obj-loop/out $SUBJECT/obj-loop/src/appl/jasper --output /tmp/out.jpg --input @@
